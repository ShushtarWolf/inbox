...
<template>
  <div class="space-y-4">
    ...
    <div class="max-w-lg space-y-2 rounded-xl border bg-white p-4">
      <input v-model="form.title" :placeholder="t('owner.packagesPage.title')" class="w-full rounded border px-2 py-1.5" />
      ...
      <input v-model.number="form.price" type="number" :placeholder="t('owner.packagesPage.price')" class="w-full rounded border px-2 py-1.5" />
      <input v-model.number="form.discount" type="number" :placeholder="t('owner.packagesPage.discount')" class="w-full rounded border px-2 py-1.5" />
      <button type="button" class="btn-primary" @click="create">{{ t('owner.packagesPage.saveStub') }}</button>
    </div>
  </div>
</template>
