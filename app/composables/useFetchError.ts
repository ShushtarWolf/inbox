...
export function fetchErrorMessage(error: unknown, fallback: string, translate?: (key: string) => string) {
  ...
  const errorKeyMap: Record<string, string> = {
    ...
    'Online checkout is disabled; pay at the club or use wallet balance': 'booking.onlinePaymentsRequired',
    ONLINE_PAYMENTS_REQUIRED: 'booking.onlinePaymentsRequired',
    ...
    'Reschedule window has passed': 'booking.errors.rescheduleWindowPassed',
    'Target slot is not available': 'booking.errors.slotNotAvailable',
