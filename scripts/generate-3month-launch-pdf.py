...
MONTHS = [
    {
        ...
        "rows": [
            ("۱", "ثبت ترمینال SEP (سامان)", "۲۰ تیر", "۱–۲ هفته (اداری)", "۵–۱۰ م.ت ضمانت"),
            ...
            ("۵", "SEP live + callback", "۳ مرداد", "۱۶–۲۴ ساعت", "—"),
...
<body>
  <div class="page">
    ...
    <p class="intro">
      <strong>رزرو واقعی</strong> = ورزشکار/باشگاه خارج از دایره تست داخلی بهناز، با پرداخت SEP و SMS تأیید.
    </p>
