...
async function main() {
  ...
  const ownerPaths = ['/owner', '/owner/calendar', '/owner/finance', '/owner/finance/report', '/owner/equipments', '/owner/discounts', '/owner/packages', '/owner/crm', '/owner/coaches', '/owner/support', '/owner/settings']
