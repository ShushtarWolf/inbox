    ...
    extend: {
      ...
      colors: {
        brand: {
          ...
          'gold-dark': palette.brand.goldDark,
          'gold-soft': palette.brand.goldSoft,
      ...
      boxShadow: {
        card: '0 4px 24px rgba(44, 44, 42, 0.08)',
        glass: '0 4px 24px rgba(44, 44, 42, 0.08)',
        venus: '0 4px 24px rgba(44, 44, 42, 0.08)',
        'venus-sm': '0 2px 8px rgba(44, 44, 42, 0.06)',
        'venus-focus': '0px 0px 0px 4px rgba(196, 30, 30, 0.12)',
